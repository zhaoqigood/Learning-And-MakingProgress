...
public class Intermediate_Register1 {
    static Intermediate_Register1 _instance = null;
    ...
    private Intermediate_Register1(){

    }
    public static Intermediate_Register1 get_instance(){
        if(_instance ==null){
            _instance = new Intermediate_Register1();
        }
        return _instance;
    }
    ...
    public void transfer(Instruction intermediate_register1){
