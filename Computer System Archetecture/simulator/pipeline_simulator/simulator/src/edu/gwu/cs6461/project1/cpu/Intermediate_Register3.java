...
public class Intermediate_Register3 {
    static Intermediate_Register3 _instance = null;
    ...
    private Intermediate_Register3(){

    }
    public static Intermediate_Register3 get_instance(){
        if(_instance ==null){
            _instance = new Intermediate_Register3();
        }
        return _instance;
    }
    ...
    // transfer the data in intermediate register2 to intermediate register3
    public void transfer(Intermediate_Register2 intermediate_register2){
        instruct_code = intermediate_register2.getInstruct_code() ;
        opcode = intermediate_register2.getOpcode();
        valP = intermediate_register2.getValP();
        ix = intermediate_register2.getIx();
        r = intermediate_register2.getR();
        i = intermediate_register2.getI();
        address = intermediate_register2.getAddress();
        immed = intermediate_register2.getImmed();
        rx = intermediate_register2.getRx();
        ry = intermediate_register2.getRy();
        al = intermediate_register2.getAL();
        lr = intermediate_register2.getLR();
        count = intermediate_register2.getCount();
        devID = intermediate_register2.getDevID();
        input = intermediate_register2.getInput();
        output = intermediate_register2.getOutput();
        device_Status = intermediate_register2.getStatus();
        valA = intermediate_register2.getValA();
        valB = intermediate_register2.getValB();
        EA = intermediate_register2.getEA();
        operand1 = intermediate_register2.getOperand1();
        operand2 = intermediate_register2.getOperand2();
        valE = intermediate_register2.getValE();
        valM = intermediate_register2.getValM();
        ticks = intermediate_register2.getTicks();
        state = intermediate_register2.getState();
        trapCode = intermediate_register2.getTrapCode();
        valM1 = intermediate_register2.getValM1();
    }
