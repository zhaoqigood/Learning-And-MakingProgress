...
public class Intermediate_Register4 {
    static Intermediate_Register4 _instance = null;
    ...
    private Intermediate_Register4(){

    }
    public static Intermediate_Register4 get_instance(){
        if(_instance ==null){
            _instance = new Intermediate_Register4();
        }
        return _instance;
    }
    ...
    // transfer the data in intermediate register3 to intermediate register4
    public void transfer(Intermediate_Register3 intermediate_register3){
        instruct_code = intermediate_register3.getInstruct_code() ;
        opcode = intermediate_register3.getOpcode();
        valP = intermediate_register3.getValP();
        ix = intermediate_register3.getIx();
        r = intermediate_register3.getR();
        i = intermediate_register3.getI();
        address = intermediate_register3.getAddress();
        immed = intermediate_register3.getImmed();
        rx = intermediate_register3.getRx();
        ry = intermediate_register3.getRy();
        al = intermediate_register3.getAL();
        lr = intermediate_register3.getLR();
        count = intermediate_register3.getCount();
        devID = intermediate_register3.getDevID();
        input = intermediate_register3.getInput();
        output = intermediate_register3.getOutput();
        device_Status = intermediate_register3.getStatus();
        valA = intermediate_register3.getValA();
        valB = intermediate_register3.getValB();
        EA = intermediate_register3.getEA();
        operand1 = intermediate_register3.getOperand1();
        operand2 = intermediate_register3.getOperand2();
        valE = intermediate_register3.getValE();
        valM = intermediate_register3.getValM();
        ticks = intermediate_register3.getTicks();
        state = intermediate_register3.getState();
        trapCode = intermediate_register3.getTrapCode();
        valM1 = intermediate_register3.getValM1();
    }
