...
public class Intermediate_Register5 {
    static Intermediate_Register5 _instance = null;
    ...
    private Intermediate_Register5(){

    }
    public static Intermediate_Register5 get_instance(){
        if(_instance ==null){
            _instance = new Intermediate_Register5();
        }
        return _instance;
    }
    ...
    // transfer the data in intermediate register4 to intermediate register5
    public void transfer(Intermediate_Register4 intermediate_register4){
        instruct_code = intermediate_register4.getInstruct_code() ;
        opcode = intermediate_register4.getOpcode();
        valP = intermediate_register4.getValP();
        ix = intermediate_register4.getIx();
        r = intermediate_register4.getR();
        i = intermediate_register4.getI();
        address = intermediate_register4.getAddress();
        immed = intermediate_register4.getImmed();
        rx = intermediate_register4.getRx();
        ry = intermediate_register4.getRy();
        al = intermediate_register4.getAL();
        lr = intermediate_register4.getLR();
        count = intermediate_register4.getCount();
        devID = intermediate_register4.getDevID();
        input = intermediate_register4.getInput();
        output = intermediate_register4.getOutput();
        device_Status = intermediate_register4.getStatus();
        valA = intermediate_register4.getValA();
        valB = intermediate_register4.getValB();
        EA = intermediate_register4.getEA();
        operand1 = intermediate_register4.getOperand1();
        operand2 = intermediate_register4.getOperand2();
        valE = intermediate_register4.getValE();
        valM = intermediate_register4.getValM();
        ticks = intermediate_register4.getTicks();
        state = intermediate_register4.getState();
        trapCode = intermediate_register4.getTrapCode();
        valM1 = intermediate_register4.getValM1();
    }
