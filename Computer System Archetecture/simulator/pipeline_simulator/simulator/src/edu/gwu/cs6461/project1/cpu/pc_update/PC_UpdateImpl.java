...
public class PC_UpdateImpl implements PC_Update {
    ...
    public short pcUpdate(Intermediate_Register5 instruction){
        switch(instruction.getOpcode()){
            ...
            case InstructionType.VSUB:
                registers.setPC((short)(instruction.getValP()+5)); // PC = valP
            ...
            case InstructionType.RFS:
                registers.setPC((short)(instruction.getValA())); // PC = valA
